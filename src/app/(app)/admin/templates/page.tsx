    ...
    return (
        <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Textarea id="description" defaultValue="Establecer un plan de estudio para mejorar la calificación final." className="col-span-3" />
            </div>
        </div>
    )
}
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Edita o elimina las plantillas disponibles.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
