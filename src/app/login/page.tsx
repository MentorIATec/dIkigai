...
const isDevProvider = AUTH_PROVIDER === 'dev';
      ...
      <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-6">
        <div className="space-y-2 text-center">
          ...
          <p className="text-muted-foreground">
            Esta instalación está configurada para utilizar un proveedor externo (por ejemplo, Firebase Auth). Completa la
            integración para habilitar el inicio de sesión.
          </p>
        </div>
      ...
      <div className="w-full max-w-md space-y-6 rounded-lg bg-background p-8 shadow-sm">
        <div className="space-y-2 text-center">
          ...
          <p className="text-sm text-muted-foreground">
            Usa este formulario para simular una sesión. Cuando la integración con el proveedor real esté lista, reemplaza
            este flujo por el inicio de sesión institucional.
          </p>
        </div>
